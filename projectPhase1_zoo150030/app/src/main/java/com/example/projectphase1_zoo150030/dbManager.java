...
public class dbManager extends SQLiteOpenHelper
{
    ...
    private static final String COL6 = "AddrL1";
    private static final String COL7 = "AddrL2";
    private static final String COL8 = "City";
    private static final String COL9 = "State";
    private static final String COL10 = "Zip";
    ...
    private static final String INIT_STRING = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME +
            ...
            "AddrL1 TEXT NOT NULL, AddrL2 TEXT, City TEXT NOT NULL, State TEXT NOT NULL, Zip TEXT NOT NULL)";
    ...
    public Contact query(String fname, String lname) throws IllegalArgumentException
    {
        ...
        if(results.moveToNext())
        {
            ...
            a.setAddrL1(results.getString(results.getColumnIndexOrThrow(COL6)));
            a.setAddrL2(results.getString(results.getColumnIndexOrThrow(COL7)));
            a.setCity(results.getString(results.getColumnIndexOrThrow(COL8)));
            a.setState(results.getString(results.getColumnIndexOrThrow(COL9)));
            a.setZip(results.getString(results.getColumnIndexOrThrow(COL10)));
    ...
    public void insertContact(Contact c) throws SQLException
    {
        ...
        input.put(COL6, c.getAddr().getAddrL1());
        input.put(COL7, c.getAddr().getAddrL2());
        input.put(COL8, c.getAddr().getCity());
        input.put(COL9, c.getAddr().getState());
        input.put(COL10, c.getAddr().getZip());
    ...
    public void updateContact(Contact updatedContact) throws IllegalArgumentException
    {
        ...
        input.put(COL6, updatedContact.getAddr().getAddrL1());
        input.put(COL7, updatedContact.getAddr().getAddrL2());
        input.put(COL8, updatedContact.getAddr().getCity());
        input.put(COL9, updatedContact.getAddr().getState());
        input.put(COL10, updatedContact.getAddr().getZip());
