...
public class dateSelector extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        if(date != null)
        {
            ...
            dp.init(dateInts[2], dateInts[0]-1, dateInts[1], null);
        }
        else
        {
    ...
    {
        /*
         * If the this button is selected, the current settings of the spinners will be ignored and the
         * date that was displayed originally will be returned.
         */
        @Override
        public void onClick(View v)
        {
            ((contactDetails)getActivity()).sendDate(prevDate, dateType);
        }
    }
}
